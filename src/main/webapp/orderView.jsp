	...
	<table class="table table-striped pb-5">	
	  <thead>
	    <tr>
		  ...
		  <th Style = "display:none;"scope="col">Med ID</th>
	  ...
	  <tbody>
		...
		String sql = "select * from echanneling.order where idpatient='"+ pid +"'";
		  ...
		  <td class="align-middle">
			...
			<div class="mb-3" Style = "display:none;">
				<label for="exampleInputEmail1" class="form-label">Channel
					...
					value='<%=resultSet.getString("idorder")%>' name="oid" readonly>
			</div>

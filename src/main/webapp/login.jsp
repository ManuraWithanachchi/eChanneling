...
<body>
	...
	<div class="px-4 py-5  text-center">
		<img class="d-block mx-auto mb-4" src="images/icons8-tasklist-96.png"
			alt="">
		<h1 class="display-5 fw-bold">E-Channelling System</h1>
		<div class="col-lg-12 mx-auto">
			<p class="lead mb-4">Welcome to our e-channeling System.</p>
		</div>
	</div>
  ...
  <form action="login" method = "POST">
   <!--  <img class="mb-4" src="../assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
    ...
    <div class="form-floating">
      <input type="text" name = "uid" class="form-control" id="floatingInput" placeholder="">
